    ...
    render() {
        ...
        return (
            <StyledWrapper>
                ...
                <p style={{ fontSize: "20px", padding: '15px 0 0 0px', marginBottom: "5px" }}>1) รายละเอียด</p>
                <div className="title-offer">
                ...
                <p style={{ fontSize: "20px", paddingTop: '15px' }}>2) รายละเอียดคุณลักษณะเฉพาะ/ขอบเขตงาน</p>
                <div className="title-offer">
                ...
                <p style={{ fontSize: "20px", paddingTop: '15px' }}>3) คณะกรรมการ</p>
                <div className="block">
                ...
                <p style={{ fontSize: "20px", paddingTop: '15px' }}>4) แหล่งเงิน</p>
